package com.example.administrator.myhttptest.amvp.activity.guide;
...
import com.example.administrator.myhttptest.amvp.activity.main.MainActivity;
...
//        // 使屏幕不显示标题栏(必须要在setContentView方法执行前执行)
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_go:
                IntentUtils.goActivity(new Intent(GuideActivity.this,MainActivity.class));
                finish();
                break;
        }
    }
