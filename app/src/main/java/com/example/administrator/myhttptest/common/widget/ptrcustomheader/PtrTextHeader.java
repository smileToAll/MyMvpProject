...
/**
 * Created by wangce on 16/2/21.
 */
public class PtrTextHeader extends FrameLayout implements PtrUIHandler {


    private static final String TEXT_REFRESHING = "正在刷新...";
    private static final String TEXT_REFRESH_COMPLETE = "刷新成功";
    private static final String TEXT_PULL_TO_REFRESH = "下拉刷新";
    private static final String TEXT_RELEASE_TO_REFRESH = "释放刷新";
    ...
    public PtrTextHeader(Context context) {
        super(context);
        initViews(null);
    }

    public PtrTextHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrTextHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        mTitleTextView.setText(TEXT_PULL_TO_REFRESH);
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(TEXT_REFRESHING);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(TEXT_REFRESH_COMPLETE);
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(TEXT_RELEASE_TO_REFRESH);
        }
    }
