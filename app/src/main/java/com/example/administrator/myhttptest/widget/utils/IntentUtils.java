package com.example.administrator.myhttptest.widget.utils;
...
/*
    ...
    *//**
    ...
    public static Intent buildImageGetIntent(Uri saveTo, int outputX, int outputY, boolean returnData) {
        back buildImageGetIntent(saveTo, 1, 1, outputX, outputY, returnData);
    }
